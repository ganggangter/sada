--//====================================================\\--//======================\\
--||         GOOD COP BAD COP BY SHACKLUSTER // CONVERTED TO FE BY SWAGGERMASTERYOLO||
--\\====================================================//--\\======================//
...
local Hat = AlignChar:FindFirstChild("Nightstick")
...
Align(Hat.Handle,AlignChar.Reanimate.Adds.Baton,Vector3.new(0,0,0),Vector3.new(-400,0,0))
--ALIGN
local AlignChar = game.Players.LocalPlayer.Character
local Hat = AlignChar:FindFirstChild("RightMk73LP")
...
Hat.Handle.AccessoryWeld:Destroy()
Align(Hat.Handle,AlignChar.Reanimate.Adds.Gun,Vector3.new(0,0.1,0),Vector3.new(270,80,10))
--//=================================\\
